...
type SecureStorageKeys = "userId"|"email"| "image"| "fName"|"lName"|"userName"
...
export class SecureStorage {
    ...
    async clearAll(): Promise<boolean> {
        try {
          const keys: SecureStorageKeys[] = ["userId", "email", "fName","image","lName","userName"]; // Add other keys if needed
